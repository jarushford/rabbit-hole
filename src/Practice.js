    ...
    return (
      <div className="practice-page" onClick={this.toggleSolution}>
        <button className="home-button" onClick={() => {
          ...
          <button className="direction-button previous-button" onClick={() => this.changeProblem(-1)}><i className="fas fa-long-arrow-alt-left"></i>Previous</button>
          <button className="direction-button next-button" onClick={() => this.changeProblem(1)}>Next<i className="fas fa-long-arrow-alt-right"></i></button>
      </div>
    )
  }
}